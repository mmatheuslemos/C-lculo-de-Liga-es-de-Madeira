 ...
 * @author mathe
 */
public class TelaCorteDuplo10 extends javax.swing.JFrame {
    
    private TelaTabelasdemadeira janela2;

    
    
    public TelaCorteDuplo10() {
        this.setLocation(233,120);
        initComponents();
        this.janela2 = new TelaTabelasdemadeira();
        int valorprego;
    ...
    private void initComponents() {
        ...
        espessurat3 = new javax.swing.JTextField();
        ...
        setTitle("Dimensionamento Corte Duplo");
        ...
        teladefundoprincipal.setIcon(new javax.swing.ImageIcon(getClass().getResource("/projetomadeira/telaprincipal.png"))); // NOI18N
        ...
        tipodeligaçãoaserescolhida.add(ligaçãoparafusada1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 100, -1, -1));
        ...
        tipodeligaçãoaserescolhida.add(ligacaocavilha1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 150, -1, -1));
        ...
        fundodatelaligação.setIcon(new javax.swing.ImageIcon(getClass().getResource("/projetomadeira/escolherligação.png"))); // NOI18N
        ...
        espessurat3.setBackground(new java.awt.Color(223, 104, 4));
        espessurat3.setFont(new java.awt.Font("Arial Unicode MS", 0, 12)); // NOI18N
        espessurat3.setForeground(new java.awt.Color(255, 255, 255));
        espessurat3.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        espessurat3.setBorder(null);
        espessurat3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                espessurat3ActionPerformed(evt);
            }
        });
        Escolhamadeira.add(espessurat3, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 452, 30, 25));
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/projetomadeira/fdgdfgd.png"))); // NOI18N
        ...
        resultadosdospregos.add(jLabel88, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 120, -1, -1));

        jLabel89.setText("jLabel89");
        resultadosdospregos.add(jLabel89, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 120, -1, -1));

        jLabel90.setText("jLabel90");
        resultadosdospregos.add(jLabel90, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 130, -1, -1));
        ...
        Resultadoparafuso.add(jLabel85, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 120, -1, -1));

        jLabel86.setText("jLabel86");
        Resultadoparafuso.add(jLabel86, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 40, -1, -1));

        jLabel87.setText("jLabel87");
        Resultadoparafuso.add(jLabel87, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 90, -1, -1));
    ...
    private void espessurat3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_espessurat3ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_espessurat3ActionPerformed
    ...
    private void jLabel16MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel16MouseClicked
        ...
        double te = 0;
        /*todos os menores de todos*/
        if(((t1n<=t2n/2) && t1n<=t3n)){
            te = t1n;
        }
        if((t1n>=(t2n/2) && t3n>=(t2n/2))){
            te = (t2n/2);
        }
        if((t3n<=(t2n/2) && t3n<=t1n)){
            te = (t3n);
        }
        ...
        jLabel68.setText(String.format(fe.format(resmad1*0.25)));
        jLabel88.setText(String.format(fe.format(resultado0)));
        jLabel89.setText(String.format(fe.format(resultado90)));
        jLabel70.setText(String.format(fe.format(result90mad)));
        jLabel90.setText(String.format(fe.format(fc0dmad1*0.25)));
        jLabel71.setText(String.format(fe.format(rescis)));
        if(am0.isSelected()){
    ...
    private void jLabel14MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel14MouseClicked
        ...
        jLabel61.setText(String.valueOf(alfae));
        resultado90 = (0.25*fc0dmad1*alfae);
        jLabel44.setText(String.format(fe.format(resultado0*0.25)));
        double fv0d =  (kmodfinalmad1*(rescis/(1.8)))/10;
        jLabel60.setText(String.format(fe.format(fv0d)));
        ...
        /*colocando os embutimentos*/
        jLabel85.setText(String.format(fe.format(resultado0)));
        jLabel86.setText(String.format(fe.format(resultado90)));
        jLabel87.setText(String.format(fe.format(resultadofinal)));
        
        /*termino de colocar embutimento*/
    ...
    private void jLabel35MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel35MouseClicked
        ...
        if((ligacaocavilha1.isSelected()==false && ligaçãoparafusada1.isSelected()==false && ligpara.isSelected()==false && ligprego.isSelected()==false)||(ligaçãoparafusada1.isSelected() && ligprego.isSelected()==false && ligpara.isSelected()==false)){
        ...
        /*Condições de Tração e Compressão*/
        int distextremo = 0; 
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            PdfPCell propriedad123 = new PdfPCell(new Phrase("t3 (espessura da peça 3)",f5));
            PdfPCell dfdfdfd23 = new PdfPCell(new Phrase(espessurat3.getText()+" cm",f5));
        ...
        if("Bibliotecas, arquivos, oficinas ou garagens".equals(aci)){
            ...
            PdfPCell lin2col2tab8 = new PdfPCell(new Phrase(jLabel85.getText()+" kN/cm²",f5));
            ...
            PdfPCell lin3col2tab8 = new PdfPCell(new Phrase(jLabel86.getText()+" kN/cm²",f5));
        ...
        if("Compressão".equals(jLabel20.getText().toString())){
            ...
            if(angdif.isSelected()){
                imagemcorte = "C:\\\\Users\\\\mathe\\\\Documents\\\\NetBeansProjects\\\\ProjetoMadeira\\\\src\\\\imagens\\\\imageminclinadacorteduplo.JPG";
            }
            if(ang90.isSelected()){
                 imagemcorte = "C:\\\\Users\\\\mathe\\\\Documents\\\\NetBeansProjects\\\\ProjetoMadeira\\\\src\\\\imagens\\\\imagem90corteduplo.JPG";
            }
            if(am0.isSelected()){
                 imagemcorte = "C:\\\\Users\\\\mathe\\\\Documents\\\\NetBeansProjects\\\\ProjetoMadeira\\\\src\\\\imagens\\\\Imagemcorte duplo10grau.png";
            }
            try {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if("Bibliotecas, arquivos, oficinas ou garagens".equals(aci)){
            ...
            /*terceira linha tabela 6*/
            PdfPCell resistacom236 = new PdfPCell(new Phrase("Resistência ao Compressão normal as fibras (fc90d).",f5));
            PdfPCell comprdf236 = new PdfPCell(new Phrase(jLabel90.getText()+" kN/cm²",f5));
            comprdf236.setHorizontalAlignment(Element.ALIGN_CENTER);
           ...
           /*primeira linha tabela 8*/
            ...
            Classecarre3678.setHorizontalAlignment(Element.ALIGN_CENTER);
              ...
              /*segunda linha tabela 8*/
            PdfPCell lin2col1tab8 = new PdfPCell(new Phrase("Resistência ao embutimento da Madeira paralelo as fibras (fe0d)",f5));
            PdfPCell lin2col2tab8 = new PdfPCell(new Phrase(jLabel88.getText()+" kN/cm²",f5));
            lin2col2tab8.setHorizontalAlignment(Element.ALIGN_CENTER);
            
            /*terceira linha tabela 8*/
            PdfPCell lin3col1tab8 = new PdfPCell(new Phrase("Resistência ao embutimento da Madeira normal as fibras (fe90d)",f5));
            PdfPCell lin3col2tab8 = new PdfPCell(new Phrase(jLabel89.getText()+" kN/cm²",f5));
            lin3col2tab8.setHorizontalAlignment(Element.ALIGN_CENTER);
            
            /*quarta linha tabela 8*/
            PdfPCell classecarre13678 = new PdfPCell(new Phrase("Resistência ao embutimento da Madeira paralelo as fibras (fe"+jLabel57.getText()+"d)",f5));
            PdfPCell classerist123678 = new PdfPCell(new Phrase(jLabel50.getText()+" kN/cm²",f5));
            classerist123678.setHorizontalAlignment(Element.ALIGN_CENTER);
            ...
            PdfPCell compr12= new PdfPCell(new Phrase(jLabel74.getText()+" kN",f5));
            compr12.setHorizontalAlignment(Element.ALIGN_CENTER);
        ...
        if("Compressão".equals(jLabel20.getText().toString())){
            ...
            PdfPCell resistacom23678912 = new PdfPCell(new Phrase("Resistência de um Corte",f5));
            resistacom23678912.setHorizontalAlignment(Element.ALIGN_CENTER);
            PdfPCell comprdf23678912 = new PdfPCell(new Phrase(jLabel73.getText()+"kN",f5));
            comprdf23678912.setHorizontalAlignment(Element.ALIGN_CENTER);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if("Bibliotecas, arquivos, oficinas ou garagens".equals(aci)){
            ...
            PdfPCell compr12= new PdfPCell(new Phrase(jLabel84.getText()+" kN",f5));
            compr12.setHorizontalAlignment(Element.ALIGN_CENTER);
        ...
        if("Compressão".equals(jLabel20.getText().toString())){
            ...
            PdfPCell resistacom23678912 = new PdfPCell(new Phrase("Resistência de um Corte",f5));
            resistacom23678912.setHorizontalAlignment(Element.ALIGN_CENTER);
            PdfPCell comprdf23678912 = new PdfPCell(new Phrase(jLabel83.getText()+" kN",f5));
            comprdf23678912.setHorizontalAlignment(Element.ALIGN_CENTER);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCorteDuplo10.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCorteDuplo10().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField espessurat3;
